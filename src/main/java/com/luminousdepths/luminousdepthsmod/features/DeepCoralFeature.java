package com.luminousdepths.luminousdepthsmod.features;

import com.luminousdepths.luminousdepthsmod.registries.LuminousBlockTags;
...
public abstract class DeepCoralFeature extends Feature<NoFeatureConfig> {
    public DeepCoralFeature(Function<Dynamic<?>, ? extends NoFeatureConfig> p_i49898_1_) {
        super(p_i49898_1_);
    }
            ...
            for(Direction direction : Direction.Plane.HORIZONTAL) {
                if (p_204624_2_.nextFloat() < 0.2F) {
                    ...
                    if (p_204624_1_.getBlockState(blockpos1).getBlock() == Blocks.WATER) {
                        BlockState blockstate1 = LuminousBlockTags.DEEP_WALL_CORALS.getRandomElement(p_204624_2_).getDefaultState().with(DeadCoralWallFanBlock.FACING, direction);
