...
import com.luminousdepths.luminousdepthsmod.features.DeepCoralFeature;
...
public class DeepCoralMushroomFeature extends DeepCoralFeature {
    public DeepCoralMushroomFeature(Function<Dynamic<?>, ? extends NoFeatureConfig> p_i49897_1_) {
        super(p_i49897_1_);
    }
